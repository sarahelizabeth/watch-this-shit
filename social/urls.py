...
urlpatterns = [
    ...
    path('accounts/password-change-success/', views.PasswordChangeDoneView.as_view(template_name='registration/password-change-success.html'), name='password-change-success'),
]
